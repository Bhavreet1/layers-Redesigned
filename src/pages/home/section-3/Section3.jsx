...
const Section3 = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            img: "/products/ipad1.png",
            features: ["Perfect Fit", "Anti-Fingerprint", "Wireless Charging Compatible"],
            alignment: "right"
        },
        {
            id: 4,
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <motion.div
                    ...
                    animate={{
                        scale: [1, 1.3, 1],
                        rotate: [0, 180, 360],
                        borderColor: ["rgba(147, 197, 253, 0.5)", "rgba(59, 130, 246, 0.7)", "rgba(147, 197, 253, 0.5)"]
                    }}
                    transition={{
                        scale: { duration: 8, repeat: Infinity, ease: "easeInOut" },
                ...
                <motion.div
                    ...
                    animate={{
                        ...
                        x: [0, 20, 0],
                        scale: [1, 1.4, 1],
                        backgroundColor: ["rgba(219, 234, 254, 0.6)", "rgba(147, 197, 253, 0.8)", "rgba(219, 234, 254, 0.6)"]
                    }}
                    transition={{
                ...
                {products.map((product, index) => {
                    ...
                    return (
                        <motion.div
                            key={product.id}
                            ref={productRef}
                            className={`flex flex-col lg:flex-row items-center justify-between min-h-[33vh] py-16 ${product.alignment === 'left' ? 'lg:flex-row-reverse' : ''
                                }`}
                        ...
                        >
                            {/* Text Content */}
                            <motion.div
                                className={`w-full lg:w-1/2 ${product.alignment === 'right' ? 'lg:pr-12' : 'lg:pl-12'}`}
                                initial={{ opacity: 0, x: product.alignment === 'right' ? -50 : 50 }}
                                animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: product.alignment === 'right' ? -50 : 50 }}
                            ...
                            >
                                ...
                                >
                                    {product.features.map((feature, featureIndex) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <span className="text-gray-700 font-[aeonic]">{feature}</span>
                                        </motion.div>
                                    ))}
                                </motion.div>
                                ...
                                {/* CTA Button */}
                                <motion.button
                                    className="group relative px-6 py-3 text-gray-900 font-medium border border-gray-300 rounded-md hover:bg-blue-300 transition-all duration-200 bg-blue-300/70 overflow-hidden"
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                            ...
                            {/* Image Container */}
                            <motion.div
                                className={`w-full lg:w-1/2 mt-12 lg:mt-0 ${product.alignment === 'right' ? 'lg:pl-12' : 'lg:pr-12'}`}
                                initial={{ opacity: 0, x: product.alignment === 'right' ? 50 : -50 }}
                                animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: product.alignment === 'right' ? 50 : -50 }}
                                    ...
                                    >
                                        ...
                                        <div className="placeholder-content absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
                                            ...
                                            >
                                                ...
                                                <p className="text-blue-600 font-semibold text-lg">{product.title}</p>
                                                <p className="text-blue-500 text-sm mt-2">Premium Quality Image</p>
                                            </motion.div>
                                        </div>
