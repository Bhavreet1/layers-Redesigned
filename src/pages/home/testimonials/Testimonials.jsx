...
const Testimonials = () => {
    ...
    const xMobile = useTransform(scrollYProgress, [0.1, 0.9], ["10%", "-882%"]); // Mobile
    const xTablet = useTransform(scrollYProgress, [0.1, 0.9], ["10%", "-400%"]); // Tablet
    ...
    const testimonials = [
        {
            ...
            rating: 5,
            testimonial: 'Since integrating this solution into our workflow, we\'ve experienced a significant improvement in efficiency and collaboration. The results exceeded our expectations.',
            imageUrl: './woman.png'
        },
        {
            name: 'David Patel',
            ...
            rating: 5,
            testimonial: 'I\'ve tested numerous options in this category, but one stands out for its intuitive design and comprehensive functionality. Absolutely game-changing!',
            imageUrl: './man.png'
        },
        {
            name: 'Emily Carter',
            ...
            rating: 5,
            testimonial: 'The tool we\'ve adopted has surpassed our expectations, providing invaluable insights and support as our business continues to grow.',
            imageUrl: './woman.png'
        },
        {
            name: 'Michael Chen',
            ...
            rating: 5,
            testimonial: 'Outstanding quality and attention to detail. The team delivered exactly what we envisioned and more. Highly recommended for any creative project.',
        ...
        },
        {
            ...
            rating: 5,
            testimonial: 'Exceptional service and results that speak for themselves. Our engagement rates have increased by 300% since implementing their strategies.',
        ...
        },
        {
            ...
            rating: 5,
            testimonial: 'The technical expertise and innovative approach impressed our entire development team. They solved complex challenges with elegant solutions.',
        ...
        },
        {
            ...
            rating: 5,
            testimonial: 'From concept to execution, the professionalism and quality of work was outstanding. They helped transform our vision into reality.',
        ...
        },
        {
            ...
            rating: 5,
            testimonial: 'Incredible attention to user experience and functionality. The final product exceeded all our requirements and user feedback has been phenomenal.',
            imageUrl: 'https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?w=100&h=100&fit=crop&crop=face'
        },
        {
            ...
            rating: 5,
            testimonial: 'The design process was collaborative and insightful. They understood our brand perfectly and delivered designs that truly represent our values.',
        ...
        },
        {
            ...
            rating: 5,
            testimonial: 'The analytical approach and data-driven solutions provided clear ROI. Our decision-making process has become significantly more efficient.',
            ...
            >
                ...
                <div className="h-screen flex flex-col justify-center z-10">
                    ...
                    >
                        ...
                        >
                            Discover what our satisfied customers have to say<br />
                        ...
                        <motion.div
                            ...
                            style={{
                                x: typeof window !== 'undefined'
                                    ? window.innerWidth < 768 ? xMobile
                                        : window.innerWidth < 1024 ? xTablet
                                            : xDesktop
                                    : xDesktop
                            }}
                        >
                            {testimonials.map((testimonial, index) => (
                                <motion.div
                                    key={index}
                                    className="group min-w-[350px] xl:min-w-[420px] max-w-[420px] bg-gradient-to-br from-white/5 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 transition-all hover:border-white/50"
                                    initial={{ opacity: 0, y: 50 }}
                                    animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
                                    transition={{
                                        duration: 0.3,
